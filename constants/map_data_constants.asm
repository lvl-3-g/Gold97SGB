...
; FishGroups indexes (see data/wild/fish.asm)
	...
	const FISHGROUP_WATER_1
	const FISHGROUP_WATER_2
	const FISHGROUP_WATER_3
	const FISHGROUP_WATER_4
	const FISHGROUP_WATER_5
	const FISHGROUP_QWILFISH_SWARM; UNUSED
	const FISHGROUP_REMORAID_SWARM; UNUSED
	const FISHGROUP_GYARADOS; UNUSED
	const FISHGROUP_DRATINI_2; UNUSED
	const FISHGROUP_WATER_6
	const FISHGROUP_QWILFISH; UNUSED
	const FISHGROUP_WATER_7
	const FISHGROUP_WATER_8
