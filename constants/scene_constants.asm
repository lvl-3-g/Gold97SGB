...
; wSanskritRuinsOutsideSceneID
	const_def
	const SCENE_SANSKRITRUINSOUTSIDE_NOTHING       ; 0
	const SCENE_SANSKRITRUINSOUTSIDE_GET_UNOWN_DEX ; 1

; wSanskritRuinsResearchCenterSceneID
	const_def
	const SCENE_SANSKRITRUINSRESEARCHCENTER_NOTHING       ; 0
	const SCENE_SANSKRITRUINSRESEARCHCENTER_GET_UNOWN_DEX ; 1

; wSanskritRuinsInnerChamberSceneID
	const_def
	const SCENE_SANSKRITRUINSINNERCHAMBER_NOTHING          ; 0
	const SCENE_SANSKRITRUINSINNERCHAMBER_STRANGE_PRESENCE ; 1
...
; wDragonsMaw1FSceneID
	const_def
	const SCENE_DRAGONSMAW1F_NOTHING        ; 0
	const SCENE_DRAGONSMAW1F_CLAIR_GIVES_TM ; 1
