...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_U4U_1    ; 15
	const FRUITTREE_ROUTE_U4U_2    ; 16
	const FRUITTREE_ROUTE_U4U_3    ; 17
	const FRUITTREE_MOTOBU_PATH      ; 18
	const FRUITTREE_ROUTE_116       ; 19
	const FRUITTREE_TROPICAL_ISLAND_JUNGLE       ; 1a
