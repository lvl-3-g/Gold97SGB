...
StandCityRocketHouse_MapEvents:
	...
	db 3 ; object events
	object_event 15,  4, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, WardensGranddaughter, EVENT_ROCKETS_IN_STAND_CITY
