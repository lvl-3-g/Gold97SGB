...
StandCityRocketHouse2F_MapEvents:
	...
	db 4 ; object events
	object_event 14,  1, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 5, TrainerGruntF4, EVENT_ROCKETS_IN_STAND_CITY
	object_event 16,  5, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 5, TrainerGruntM6, EVENT_ROCKETS_IN_STAND_CITY
	object_event 17,  6, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 5, TrainerGruntM7, EVENT_ROCKETS_IN_STAND_CITY
	object_event  5,  4, SPRITE_SURGE, SPRITEMOVEDATA_STANDING_RIGHT, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 5, ObjectEvent, EVENT_ROCKETS_IN_STAND_CITY
