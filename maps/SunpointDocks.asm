...
SunpointDocks_MapEvents:
	...
	db 11 ; object events
	object_event  8,  2, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket1Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event  5, 15, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket2Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event 14, 13, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket3Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event  4,  8, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket4Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event  5, 24, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket5Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event 12, 19, SPRITE_ROCKET, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DocksRocket6Script, EVENT_ROCKETS_IN_BOAT_AT_SUNPOINT
	object_event 13,  5, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 0, TrainerGruntM29, EVENT_ROCKET_OUTSIDE_OF_SHIP
	...
	object_event  8, 13, SPRITE_FISHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, DocksFisherScript, EVENT_FLORIA_AT_FLOWER_SHOP
