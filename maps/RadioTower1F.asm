...
RadioTower1F_MapEvents:
	...
	object_event  0,  5, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 4, TrainerGruntM12, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
