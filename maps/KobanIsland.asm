...
KobanIsland_MapEvents:
	...
	object_event 13,  6, SPRITE_CLAIR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0 , -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, KobanIslandClairScript, EVENT_BLUE_FOREST_GRAMPS_BLOCKS_DRAGONS_DEN
