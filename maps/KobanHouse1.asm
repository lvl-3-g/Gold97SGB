...
KobanHouse1_MapEvents:
	...
	db 1 ; object events
	object_event  7, 4, SPRITE_CLAIR, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, KobanHouse1ClairScript, EVENT_BLUE_FOREST_GRAMPS_NOT_BLOCKING_DRAGONS_DEN
