...
Route102GameHouse_MapEvents:
	...
	object_event 7,  2, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 1, -1, -1, PAL_NPC_ORANGE, OBJECTTYPE_SCRIPT, 0, N64HouseFisherScript, EVENT_WESTPORT_UNDERGROUND_WAREHOUSE_BLOCKED_OFF
