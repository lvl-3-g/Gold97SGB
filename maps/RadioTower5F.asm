...
RadioTower5F_MapEvents:
	...
	object_event  2,  1, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 1, TrainerGruntM30, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
