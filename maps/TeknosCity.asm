...
TeknosCity_MapEvents:
	...
	object_event 23, 14, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TeknosCityLass2Script, -1
	...
	object_event  5, 28, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 1, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, TeknosCityRocket1Script, EVENT_ROCKETS_TAKE_OVER_AQUARIUM
	object_event  8, 28, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 1, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, TeknosCityRocket2Script, EVENT_ROCKETS_TAKE_OVER_AQUARIUM
	object_event  7, 28, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, TeknosCityRocket3Script, EVENT_ROCKETS_BLOCKING_AQUARIUM
	object_event  7, 30, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, TeknosCityRocket4Script, EVENT_ROCKETS_BLOCKING_AQUARIUM
	object_event  6, 29, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, TeknosCityRocket5Script, EVENT_ROCKETS_BLOCKING_AQUARIUM
