...
WhirlIslandB1F_MapEvents:
	...
	bg_event  3, 32, BGEVENT_ITEM, WhirlIslandB1FHiddenUltraBall
	...
	object_event 20,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB1FDetectOrb, EVENT_WHIRL_ISLAND_B1F_DETECT_ORB
	...
	object_event 33, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB1FEscapeRope, EVENT_WHIRL_ISLAND_B1F_ESCAPE_ROPE
	object_event 25,  4, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, WhirlIslandB1FBoulder, -1
