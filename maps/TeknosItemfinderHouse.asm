...
TeknosItemfinderHouse_MapEvents:
	...
	db 2 ; object events
	object_event  4,  4, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, TeknosItemfinderGuy, EVENT_BIRDON_GYM_GRAMPS
	object_event  2,  6, SPRITE_TWIN, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, PAL_NPC_ORANGE, OBJECTTYPE_SCRIPT, 0, TeknosHistoryBook, EVENT_WISE_TRIOS_ROOM_WISE_TRIO_2
