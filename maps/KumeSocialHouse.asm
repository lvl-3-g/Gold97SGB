...
KumeSocialHouse_MapEvents:
	...
	db 6 ; object events
	object_event  5,  1, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_ORANGE, OBJECTTYPE_SCRIPT, 0, KumeSocialHouseN64LassScript, EVENT_WESTPORT_DEPT_STORE_B1F_LAYOUT_3
