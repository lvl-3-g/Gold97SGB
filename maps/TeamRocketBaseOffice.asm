...
TeamRocketBaseOffice_MapEvents:
	...
	object_event 21,  3, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 1, RocketBossRoomGrunt1, EVENT_BLUE_FOREST_SUPER_NERD_DOES_NOT_BLOCK_GYM
	object_event 28,  6, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 1, RocketBossRoomGrunt2, EVENT_BLUE_FOREST_SUPER_NERD_DOES_NOT_BLOCK_GYM
	object_event 22, 10, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 1, RocketBossRoomGrunt3, EVENT_BLUE_FOREST_SUPER_NERD_DOES_NOT_BLOCK_GYM
	object_event 19,  7, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 1, RocketBossRoomGrunt4, EVENT_BLUE_FOREST_SUPER_NERD_DOES_NOT_BLOCK_GYM
	...
	object_event  7, 11, SPRITE_SURGE, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 1, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B1F_ELECTRODE_1
	object_event  4,  1, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 1, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B1F_ELECTRODE_1
