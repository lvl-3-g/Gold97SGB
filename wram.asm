...
wSWIslandsBadges:: flag_array NUM_SWISLANDS_BADGES
...
wOakLabFrontRoomSceneID::							  db
wOakLabBackRoomSceneID::                                 db ; d987
wPlayersHouse1FSceneID::                          db ; d988
wRoute101SceneID::                                 db ; d989
wCrownCitySceneID::                         db ; d98a
wMrPokemonsHouseSceneID::                         db ; d98b
wRoute112SceneID::                                 db ; d98c
wRoute103NationalParkGateSceneID::                 db ; d98d
wRoute102SceneID::                                 db ; d98e
...
wRoute113Route114GateSceneID::                   db ; d996
wTeknosTinTowerEntranceSceneID::                db ; d997
wTeknosPokecenter1FSceneID::                    db ; d999
wBirdonGymSceneID::                             db ; d99a
wSanskritTownSceneID::                            db ; d99b
wRouteU4USceneID::                                 db ; d99c
wSunpointCitySceneID::                            db ; d99d
wBoardwalkGateSceneID::                             db ; d9a3
wBoulderMineB4FSceneID::                               db ; d9a4
wFiveFloorTower3FSceneID::                           db ; d9a5
wHydraulicCaveSceneID::                              db ; d9a6
wBurnedTower1FSceneID::                           db ; d9a7
wBurnedTowerB1FSceneID::                          db ; d9a8
wRadioTower5FSceneID::                            db ; d9a9
wSanskritRuinsOutsideSceneID::                      db ; d9aa
wSanskritRuinsResearchCenterSceneID::               db ; d9ab
wSanskritRuinsHoOhChamberSceneID::                  db ; d9ac
wSanskritRuinsKabutoChamberSceneID::                db ; d9ad
wSanskritRuinsOmanyteChamberSceneID::               db ; d9ae
wSanskritRuinsAerodactylChamberSceneID::            db ; d9af
wSanskritRuinsInnerChamberSceneID::                 db ; d9b0
wOldMahoganyMart1FSceneID::                          db ; d9b1
wTeamRocketBaseOfficeSceneID::                       db ; d9b2
wTeamRocketBaseB1FSceneID::                       db ; d9b3
...
wMountFujiOutsideSceneID::                         db ; d9be
wKurtsHouseSceneID::							  db ; hope this works
wTeknosPortSceneID::								  db ; it did, hope this works too
...
wRoute103SceneID::								  db
wTeamRocketShipBaseSceneID::							  db
wRoute104SceneID::								  db
wRoute112StandGateSceneID::				  db
wStandCitySceneID::							  db
wStandCityRocketHouseSceneID::					  db
wStandCityRocketHouse2FSceneID::				  db
wRadioTower6FSceneID::							  db
wWestportCitySceneID::							  db
wPagotaCitySceneID::							  db
wFiveFloorTower5FSceneID::							  db
wKantoGymSceneID::                              db
wKantoBattleClubB1FSceneID::					  db
wKantoBattleClub1FSceneID::						  db
wCrownPathSceneID::						  db
