...
AquariusFrontpic:  INCBIN "gfx/pokemon/aquarius/front.2bpp.lz"
...
MadameFrontpic:    INCBIN "gfx/pokemon/madame/front.2bpp.lz"
...
AnimonFrontpic:      INCBIN "gfx/pokemon/animon/front.2bpp.lz"
...
BellringFrontpic:   INCBIN "gfx/pokemon/bellring/front.2bpp.lz"
...
ChixFrontpic:     INCBIN "gfx/pokemon/chix/front.2bpp.lz"
...
VolbearFrontpic:     INCBIN "gfx/pokemon/volbear/front.2bpp.lz"
...
AqualloFrontpic:    INCBIN "gfx/pokemon/aquallo/front.2bpp.lz"
...
PonittleFrontpic:     INCBIN "gfx/pokemon/ponittle/front.2bpp.lz"
...
OsunfishFrontpic:       INCBIN "gfx/pokemon/osunfish/front.2bpp.lz"
VolbearBackpic:      INCBIN "gfx/pokemon/volbear/back.2bpp.lz"
GelaniaFrontpic:      INCBIN "gfx/pokemon/gelania/front.2bpp.lz"
...
BipetalFrontpic:   INCBIN "gfx/pokemon/bipetal/front.2bpp.lz"
ScientistPic:        INCBIN "gfx/trainers/scientist.2bpp.lz"
PidgeyBackpic:       INCBIN "gfx/pokemon/pidgey/back.2bpp.lz"
TritalesFrontpic:  INCBIN "gfx/pokemon/tritales/front.2bpp.lz"
...
CurpanFrontpic:   INCBIN "gfx/pokemon/curpan/front.2bpp.lz"
...
ChixBackpic:      INCBIN "gfx/pokemon/chix/back_gold.2bpp.lz"
...
GrowliteFrontpic:     INCBIN "gfx/pokemon/growlite/front.2bpp.lz"
...
KotoraFrontpic:    INCBIN "gfx/pokemon/kotora/front.2bpp.lz"
...
WarwolfFrontpic:     INCBIN "gfx/pokemon/warwolf/front.2bpp.lz"
...
RaitoraFrontpic:     INCBIN "gfx/pokemon/raitora/front.2bpp.lz"
...
TwinzFrontpic:   INCBIN "gfx/pokemon/twinz/front.2bpp.lz"
...
ParetteFrontpic:   INCBIN "gfx/pokemon/parette/front.2bpp.lz"
...
GrotessFrontpic:    INCBIN "gfx/pokemon/grotess/front.2bpp.lz"
...
TurbanFrontpic:      INCBIN "gfx/pokemon/turban/front.2bpp.lz"
...
CruisealFrontpic:    INCBIN "gfx/pokemon/cruiseal/front.2bpp.lz"
...
MeowsyFrontpic:      INCBIN "gfx/pokemon/meowsy/front.2bpp.lz"
...
HappaFrontpic:   INCBIN "gfx/pokemon/happa/front.2bpp.lz"
...
WolfanFrontpic:    INCBIN "gfx/pokemon/wolfan/front.2bpp.lz"
...
PluckrossFrontpic:    INCBIN "gfx/pokemon/pluckross/front.2bpp.lz"
...
RinringFrontpic:     INCBIN "gfx/pokemon/rinring/front.2bpp.lz"
PhanpyFrontpic:      INCBIN "gfx/pokemon/phanpy/front.2bpp.lz"
TangleFrontpic:     INCBIN "gfx/pokemon/tangle/front.2bpp.lz"
...
AnchorageFrontpic:      INCBIN "gfx/pokemon/anchorage/front.2bpp.lz"
...
KingoldFrontpic:     INCBIN "gfx/pokemon/kingold/front.2bpp.lz"
...
DynabearFrontpic:  INCBIN "gfx/pokemon/dynabear/front.2bpp.lz"
...
GrimbyFrontpic:  INCBIN "gfx/pokemon/grimby/front.2bpp.lz"
MagmarFrontpic:      INCBIN "gfx/pokemon/magmar/front.2bpp.lz"
HikerPic:            INCBIN "gfx/trainers/hiker.2bpp.lz"
BomsealFrontpic:   INCBIN "gfx/pokemon/bomseal/front.2bpp.lz"
...
NumbpuffFrontpic:    INCBIN "gfx/pokemon/numbpuff/front.2bpp.lz"
