...
.swislands
	decoord 0, 0
	ld hl, SWIslandsGrassWildMons
	call .FindGrass
	ld hl, SWIslandsWaterWildMons
	jp .FindWater
...
INCLUDE "data/wild/swislands_grass.asm"
INCLUDE "data/wild/swislands_water.asm"
