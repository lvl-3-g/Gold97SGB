...
TilesetCaveAnim:
	dw vTiles2 tile $4D, ScrollTileRight
	dw vTiles2 tile $14, WriteTileToBuffer
...
WhirlpoolFrames1: dw vTiles2 tile $4E, WhirlpoolTiles1
WhirlpoolFrames2: dw vTiles2 tile $4F, WhirlpoolTiles2
WhirlpoolFrames3: dw vTiles2 tile $5E, WhirlpoolTiles3
WhirlpoolFrames4: dw vTiles2 tile $5F, WhirlpoolTiles4
