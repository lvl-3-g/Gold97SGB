...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 58, MADAME,     SWORDS_DANCE, WING_ATTACK, FLY, AGILITY;madame
	db 57, BELLRING,  HEADBUTT, BITE, DISABLE, FAINT_ATTACK;bellring
	db 60, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 57, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SCARY_FACE, ENDURE;raitora
	db 60, BLOSSOMITE,   SYNTHESIS, SLAM, RAZOR_LEAF, SOLARBEAM;blossomite
	db 57, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 60, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 57, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SCARY_FACE, ENDURE;raitora
	db 60, DYNABEAR,    ROAR, FLAME_WHEEL, SCARY_FACE, FLAMETHROWER
	db 57, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 60, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 57, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SCARY_FACE, ENDURE;raitora
	db 60, AQUARIUS, BODY_SLAM, ICY_WIND, SURF, BUBBLEBEAM
	db 57, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
