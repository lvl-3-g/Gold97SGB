...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_GS_INTRO_HAPPA,       SPRITE_ANIM_SEQ_GS_INTRO_HAPPA_CRUISEAL, $02 ; SPRITE_ANIM_INDEX_GS_INTRO_HAPPA
	db SPRITE_ANIM_FRAMESET_GS_INTRO_FLAMBEAR,       SPRITE_ANIM_SEQ_GS_INTRO_FLAMBEAR,          $02 ; SPRITE_ANIM_INDEX_GS_INTRO_FLAMBEAR
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CRUISEAL,        SPRITE_ANIM_SEQ_GS_INTRO_HAPPA_CRUISEAL, $02 ; SPRITE_ANIM_INDEX_GS_INTRO_CRUISEAL
