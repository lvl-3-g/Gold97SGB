...
TreeMonMaps:
	...
	treemon_map ROUTE_108,                  TREEMON_SET_SWISLANDS
	treemon_map ROUTE_109,                  TREEMON_SET_SWISLANDS
	treemon_map ROUTE_113,                  TREEMON_SET_SWISLANDS
	treemon_map ROUTE_112,                  TREEMON_SET_SWISLANDS
	treemon_map SEASIDE_PATH,            TREEMON_SET_SWISLANDS
	...
	treemon_map TEKNOS_CITY,             TREEMON_SET_CANYON
	treemon_map STAND_CITY,              TREEMON_SET_CANYON
	treemon_map CROWN_CITY,          TREEMON_SET_CANYON
	treemon_map AMAMI_TOWN,            TREEMON_SET_CANYON
	treemon_map KUME_CITY,               TREEMON_SET_CANYON
	treemon_map ALLOY_CITY,              TREEMON_SET_CANYON
	...
	treemon_map WEATHERED_TRAIL,               TREEMON_SET_ROUTE
	db -1
